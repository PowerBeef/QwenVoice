...
struct QVoiceiOSApp: App {
    ...
    static func makeBackend(
        ...
        // Preload model in background as soon as install completes (while still on Settings tab)
...
private struct IOSUnsupportedDeviceView: View {
    let reason: String
