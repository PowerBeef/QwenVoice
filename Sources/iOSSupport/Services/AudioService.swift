...
///
/// Mirrors `Sources/Services/AudioService.swift`. The only divergence is the
/// preferences store: iOS reads `UserDefaults.standard`; macOS reads the
/// debug-aware `AppDefaults.store`.
enum AudioService {
