...
public enum ClonePreparationState: Equatable, Sendable {
    case idle
...
public struct GenerationEvent: Equatable, Sendable {
...
public struct TTSEngineSnapshot: Equatable, Sendable {
...
@MainActor
public protocol MacTTSEngine: AnyObject {
