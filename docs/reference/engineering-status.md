...
- Batch generation is still sequential and non-streaming even though the backend and runtime now support richer streaming data and internal batch capabilities.
