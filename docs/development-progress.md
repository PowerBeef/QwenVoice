...
2. **Phase 11 stages D–E** — long-form regeneration/resume via revision lineage and History/UI
   project integration (stages A–C shipped 2026-07-23; spoken-text planning ships inside them).
   Phases 12–13 (quality consolidation, history v3) remain later work; history schema v2 still
   ships.
