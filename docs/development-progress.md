...
2. **Phase 11 live acceptance** — stages A–E shipped 2026-07-23; a real in-app long-form run
   (plan → stream → join → History project) is the remaining acceptance step, then iOS long-form
   as its own arc. Phases 12–13 (quality consolidation, history v3) remain later work; history
   schema v2 still ships.
